...
import { BALANCE_CHART_HEX_COLORS } from '@/constants';
    ...
    <Card>
      <BlockStack gap="md">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={chartData} margin={{ left: 50, right: 30 }}>
            ...
            <Line
              type="monotone"
              dataKey="収入"
              stroke={BALANCE_CHART_HEX_COLORS.income}
              strokeWidth={2}
            />
            <Line
              type="monotone"
              dataKey="支出"
              stroke={BALANCE_CHART_HEX_COLORS.expense}
              strokeWidth={2}
            />
            <Line
              type="monotone"
              dataKey="収支"
              stroke={BALANCE_CHART_HEX_COLORS.balance}
              strokeWidth={2}
            />
          </LineChart>
        </ResponsiveContainer>
